...
/obj/machinery/weather_remover/RefreshParts()
	...
	var/servo_rating
	for(var/datum/stock_part/manipulator/servos in component_parts)
...
/obj/machinery/weather_remover/item_interaction(mob/living/user, obj/item/tool, list/modifiers)
	if(!istype(tool, /obj/item/stack/sheet/mineral/plasma) || (user.istate & ISTATE_HARM) || tool.flags_1 & HOLOGRAM_1 || tool.item_flags & ABSTRACT)
...
#undef PLASMA_LESS_PER_TIER
#undef WEATHER_LIGHT_POWER
